...
const buttons = [
  ...
  { label: "Add Items", icon: <MdCategory />, action: "Items" },
...
const Dashboard = () => {
  ...
  const[isItemModelOpen, setIsItemModalOpen] = useState(false); // For AddItems
  // const[isDishsModelOpen,setIsDishModelOpen] = useState(false); // For Dishes

  const handleOpenModal = (action) => {
    if (action === "table") setIsTableModalOpen(true);

    if(action === "Items") setIsItemModalOpen(true); // Add Items 
    // if(action == "dishes") setIsDishModelOpen(true); // Add Dishes
  };
