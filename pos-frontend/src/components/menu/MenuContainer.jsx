      ...
      <div className="grid grid-cols-4 gap-4 px-10 py-4 w-[100%]">
        {selected?.items.map((item) => {
          return (
            <div
              key={item.id}
              className="flex flex-col items-start justify-between p-4 rounded-lg h-[160px] cursor-pointer hover:bg-[#2a2a2a] bg-[#1a1a1a]"
            >
              <div className="flex items-start justify-between w-full">
              ...
              <div className="flex items-center justify-between w-full mt-2">
                ...
                <input
                  ...
                  className="bg-[#1f1f1f] text-white px-3 py-2 rounded w-[90px]"
                />

                {/* Quantity Controller */}
                <div className="flex items-center justify-between bg-[#1f1f1f] px-4 py-2 rounded-lg gap-6 w-[50%]">
